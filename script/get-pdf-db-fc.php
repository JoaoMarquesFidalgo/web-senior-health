...
$user = new User();
$result = $user->mostrarFC($utenteid);
...
$pdf->Cell(280, 60, 'Dados Biométricos (Frequência Cardíaca)', 0, 1, 'C');

$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(70, 5, 'Dia da Semana', 1, 0, 'C');
$pdf->Cell(70, 5, 'Data/Hora', 1, 0, 'C');
$pdf->Cell(60, 5, 'Frequência Cardíaca', 1, 0, 'C');
...
for ($i = 0; $i < $count; $i++)
{
  ...
  $pdf->Cell(60, 5, $result[$i]['frequencia_cardiaca'], 1, 0, 'C');
  $pdf->Cell(70, 5, $result[$i]['responsavel'], 1, 1, 'C');
}


$pdf->Output('I', 'smartwalk-dados-biometricos-fc.pdf');
