 $(document).ready(function () {
 	...
 	/*$(function () {
 		$('.modal-content').keypress(function () {
 			$('#validar-senha').click();
 		})
 	});*/
 	...
 	$.ajax({
 		url: 'scriptsPHP/autenticacao-obter.php',
 		type: 'post',
 		dataType: 'json',
 	...
 	$(document).on('click', '#validar-senha', function () {
 		$.ajax({
 			url: 'scriptsPHP/autenticacao-validar-senha.php',
 			type: 'post',
 			dataType: 'json',
 			data: {
 				email: $('#email').val(),
 	...
 	$(document).on('click', '#gravar', function () {
 		...
 		$.ajax({
 			url: 'scriptsPHP/autenticacao-gravar.php',
 			type: 'post',
 			data: {
 				email: $('#email').val(),
 				password: $('#pass').val()
